...
def get_player_classic_url_list_from_matches() -> List[Dict]:
    ...
    player_classic_url_list = combine_list_of_dicts(
        player_one_url_list,
        player_two_url_list
    )

    # loop through player list
    for player_classic_url_dict in player_classic_url_list:

        # create url
        player_classic_url = create_player_classic_url(
            player_gender=player_classic_url_dict['player_gender'],
            player_name=player_classic_url_dict['player_name']
        )
        player_classic_url_dict['player_classic_url'] = player_classic_url
