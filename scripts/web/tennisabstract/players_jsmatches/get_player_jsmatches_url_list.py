...
def get_player_jsmatches_url_list() -> List[Dict]:
    """
    Returns list of player urls from source (url)
    """

    # retrieve url page
    player_list_url = 'https://www.tennisabstract.com/jsmatches'
...
player_jsmatches_url_list = get_player_jsmatches_url_list()
print(player_jsmatches_url_list)